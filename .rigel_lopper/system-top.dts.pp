#line 1 "../vitis_platform/hw/sdt/system-top.dts"
/dts-v1/;
#line 1 "../vitis_platform/hw/sdt/zynq-7000.dtsi"
...
#line 1 "../vitis_platform/hw/sdt/pl.dtsi"
/ {
	amba_pl: amba_pl {
		ranges;
		compatible = "simple-bus";
		#address-cells = <1>;
		#size-cells = <1>;
		firmware-name = "qaoa_wrapper.bit.bin";
		clocking0: clocking0 {
		...
		qaoa_kernel_0: qaoa_kernel@40000000 {
			compatible = "xlnx,qaoa-kernel-1.0";
			xlnx,ii = "159885 , ~ , 206110";
			xlnx,machine = <64>;
			xlnx,s-axi-control-addr-width = <7>;
			xlnx,rable = <0>;
			xlnx,ip-name = "qaoa_kernel";
			...
			xlnx,latency = <159885>;
			xlnx,name = "qaoa_kernel_0";
		};
	};
};
#line 1 "../vitis_platform/hw/sdt/pcw.dtsi"
	&ps7_cortexa9_0 {
		xlnx,rable = <0>;
...
#line 5 "../vitis_platform/hw/sdt/system-top.dts"
/ {
	board = "zybo";
	...
	cpus_a9: cpus-a9@0 {
		...
		address-map = <0xf0000000 &amba 0xf0000000 0x10000000>,
			      ...
			      <0x40000000 &qaoa_kernel_0 0x40000000 0x10000>,
