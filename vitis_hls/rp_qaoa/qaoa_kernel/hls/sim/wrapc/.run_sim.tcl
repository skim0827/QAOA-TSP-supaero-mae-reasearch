...
# 
# ==============================================================
set ::env(LD_LIBRARY_PATH) /usr/local/Xilinx/Vitis/2024.2/lnx64/tools/fpo_v7_1:$::env(LD_LIBRARY_PATH)
set ::env(LD_LIBRARY_PATH) /usr/local/Xilinx/Vitis/2024.2/lnx64/tools/fft_v9_1:$::env(LD_LIBRARY_PATH)
set ::env(LD_LIBRARY_PATH) /usr/local/Xilinx/Vitis/2024.2/lnx64/tools/fir_v7_0:$::env(LD_LIBRARY_PATH)
set ::env(LD_LIBRARY_PATH) /usr/local/Xilinx/Vitis/2024.2/lnx64/tools/dds_v6_0:$::env(LD_LIBRARY_PATH)
set ::env(LD_LIBRARY_PATH) /usr/local/Xilinx/Vitis/2024.2/tps/lnx64/gcc-8.3.0/lib:$::env(LD_LIBRARY_PATH)
set ::env(LD_LIBRARY_PATH) /usr/local/Xilinx/Vitis/2024.2/lib/lnx64.o/Default:$::env(LD_LIBRARY_PATH)
...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "qaoa_kernel.autotvin.dat"
	set constFileTvOut       "qaoa_kernel.autotvout.dat"
	set constFileHdlTvIn     "qaoa_kernel.autohdltvin.dat"
	set constFileHdlTvOut    "qaoa_kernel.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
