...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.qaoa_kernel.autotvin_d.dat"
         "c.qaoa_kernel.autotvin_gamma.dat"
         "c.qaoa_kernel.autotvin_beta.dat"
         "c.qaoa_kernel.autotvin_get_best_state.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.qaoa_kernel.autotvout_best_state.dat"
         "rtl.qaoa_kernel.autotvout_ap_return.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
