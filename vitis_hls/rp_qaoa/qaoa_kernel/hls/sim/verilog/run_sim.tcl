...
if {[file isfile qaoa_kernel.autotvin.dat]} {
	file delete -force qaoa_kernel.autotvin.dat
}

if {[file isfile qaoa_kernel.autotvout.dat]} {
	file delete -force qaoa_kernel.autotvout.dat
}
