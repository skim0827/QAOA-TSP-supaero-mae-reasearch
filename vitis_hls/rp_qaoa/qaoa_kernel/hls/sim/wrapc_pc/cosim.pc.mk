...
AUTOPILOT_ROOT := /usr/local/Xilinx/Vitis/2024.2
...
IFLAG += -fPIC
ifndef AP_GCC_PATH
  AP_GCC_PATH := /usr/local/Xilinx/Vitis/2024.2/tps/lnx64/gcc-8.3.0/bin
endif
AUTOPILOT_TOOL = ${AUTOPILOT_ROOT}/${AUTOPILOT_MACH}/tools
AUTOPILOT_TECH = ${AUTOPILOT_ROOT}/common/technology
  AP_CLANG_PATH := /usr/local/Xilinx/Vitis/2024.2/vcxx/libexec/
TOOLCHAIN += --gcc-toolchain=/usr/local/Xilinx/Vitis/2024.2/tps/lnx64/gcc-8.3.0
LFLAG += --gcc-toolchain=/usr/local/Xilinx/Vitis/2024.2/tps/lnx64/gcc-8.3.0
...
LFLAG += -lpthread
LFLAG += -L /usr/local/Xilinx/Vitis/2024.2/vcxx/lib/clang/14.0.6/lib/linux -lclang_rt.builtins-x86_64
...
$(ObjDir)/qaoa.cpp_pre.cpp.tb.o : qaoa.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling qaoa.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
