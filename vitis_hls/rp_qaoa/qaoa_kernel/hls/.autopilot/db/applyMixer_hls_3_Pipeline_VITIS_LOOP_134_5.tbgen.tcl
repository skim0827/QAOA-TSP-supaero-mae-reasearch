set moduleName applyMixer_hls_3_Pipeline_VITIS_LOOP_134_5
set isTopModule 0
...
set cdfgNum 20
set C_modelName {applyMixer_hls<3>_Pipeline_VITIS_LOOP_134_5}
...
set C_modelArgList {
	{ bufB_re int 32 regular {array 512 { 1 0 } 1 1 }  }
	{ bufB_im int 32 regular {array 512 { 1 0 } 1 1 }  }
	{ bufA_re int 32 regular {array 512 { 1 0 } 1 1 }  }
	{ bufA_im int 32 regular {array 512 { 1 0 } 1 1 }  }
...
set portList { 
	...
	{ bufB_re_address0 sc_out sc_lv 9 signal 0 } 
	{ bufB_re_ce0 sc_out sc_logic 1 signal 0 } 
	{ bufB_re_q0 sc_in sc_lv 32 signal 0 } 
	{ bufB_re_address1 sc_out sc_lv 9 signal 0 } 
	{ bufB_re_ce1 sc_out sc_logic 1 signal 0 } 
	{ bufB_re_we1 sc_out sc_logic 1 signal 0 } 
	{ bufB_re_d1 sc_out sc_lv 32 signal 0 } 
	{ bufB_im_address0 sc_out sc_lv 9 signal 1 } 
	{ bufB_im_ce0 sc_out sc_logic 1 signal 1 } 
	{ bufB_im_q0 sc_in sc_lv 32 signal 1 } 
	{ bufB_im_address1 sc_out sc_lv 9 signal 1 } 
	{ bufB_im_ce1 sc_out sc_logic 1 signal 1 } 
	{ bufB_im_we1 sc_out sc_logic 1 signal 1 } 
	{ bufB_im_d1 sc_out sc_lv 32 signal 1 } 
	{ bufA_re_address0 sc_out sc_lv 9 signal 2 } 
	{ bufA_re_ce0 sc_out sc_logic 1 signal 2 } 
	{ bufA_re_q0 sc_in sc_lv 32 signal 2 } 
	{ bufA_re_address1 sc_out sc_lv 9 signal 2 } 
	{ bufA_re_ce1 sc_out sc_logic 1 signal 2 } 
	{ bufA_re_we1 sc_out sc_logic 1 signal 2 } 
	{ bufA_re_d1 sc_out sc_lv 32 signal 2 } 
	{ bufA_im_address0 sc_out sc_lv 9 signal 3 } 
	{ bufA_im_ce0 sc_out sc_logic 1 signal 3 } 
	{ bufA_im_q0 sc_in sc_lv 32 signal 3 } 
	{ bufA_im_address1 sc_out sc_lv 9 signal 3 } 
	{ bufA_im_ce1 sc_out sc_logic 1 signal 3 } 
	{ bufA_im_we1 sc_out sc_logic 1 signal 3 } 
	{ bufA_im_d1 sc_out sc_lv 32 signal 3 } 
	{ state_cur_223131 sc_in sc_lv 1 signal 4 } 
	{ state_next_222129 sc_in sc_lv 1 signal 5 } 
}
set NewPortList {[ 
...
set Spec2ImplPortList { 
	bufB_re { ap_memory {  { bufB_re_address0 mem_address 1 9 }  { bufB_re_ce0 mem_ce 1 1 }  { bufB_re_q0 mem_dout 0 32 }  { bufB_re_address1 MemPortADDR2 1 9 }  { bufB_re_ce1 MemPortCE2 1 1 }  { bufB_re_we1 MemPortWE2 1 1 }  { bufB_re_d1 MemPortDIN2 1 32 } } }
	bufB_im { ap_memory {  { bufB_im_address0 mem_address 1 9 }  { bufB_im_ce0 mem_ce 1 1 }  { bufB_im_q0 mem_dout 0 32 }  { bufB_im_address1 MemPortADDR2 1 9 }  { bufB_im_ce1 MemPortCE2 1 1 }  { bufB_im_we1 MemPortWE2 1 1 }  { bufB_im_d1 MemPortDIN2 1 32 } } }
	bufA_re { ap_memory {  { bufA_re_address0 mem_address 1 9 }  { bufA_re_ce0 mem_ce 1 1 }  { bufA_re_q0 mem_dout 0 32 }  { bufA_re_address1 MemPortADDR2 1 9 }  { bufA_re_ce1 MemPortCE2 1 1 }  { bufA_re_we1 MemPortWE2 1 1 }  { bufA_re_d1 MemPortDIN2 1 32 } } }
	bufA_im { ap_memory {  { bufA_im_address0 mem_address 1 9 }  { bufA_im_ce0 mem_ce 1 1 }  { bufA_im_q0 mem_dout 0 32 }  { bufA_im_address1 MemPortADDR2 1 9 }  { bufA_im_ce1 MemPortCE2 1 1 }  { bufA_im_we1 MemPortWE2 1 1 }  { bufA_im_d1 MemPortDIN2 1 32 } } }
