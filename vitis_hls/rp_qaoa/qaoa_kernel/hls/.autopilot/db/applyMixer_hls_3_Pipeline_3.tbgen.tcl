set moduleName applyMixer_hls_3_Pipeline_3
set isTopModule 0
...
set cdfgNum 20
set C_modelName {applyMixer_hls<3>_Pipeline_3}
...
set C_modelArgList {
	{ bufB_re int 32 regular {array 512 { 3 0 } 0 1 }  }
	{ bufB_im int 32 regular {array 512 { 3 0 } 0 1 }  }
}
set hasAXIMCache 0
set l_AXIML2Cache [list]
set AXIMCacheInstDict [dict create]
set C_modelArgMapList {[ 
	{ "Name" : "bufB_re", "interface" : "memory", "bitwidth" : 32, "direction" : "WRITEONLY"} , 
 	{ "Name" : "bufB_im", "interface" : "memory", "bitwidth" : 32, "direction" : "WRITEONLY"} ]}
...
set Spec2ImplPortList { 
	bufB_re { ap_memory {  { bufB_re_address1 MemPortADDR2 1 9 }  { bufB_re_ce1 MemPortCE2 1 1 }  { bufB_re_we1 MemPortWE2 1 1 }  { bufB_re_d1 MemPortDIN2 1 32 } } }
	bufB_im { ap_memory {  { bufB_im_address1 MemPortADDR2 1 9 }  { bufB_im_ce1 MemPortCE2 1 1 }  { bufB_im_we1 MemPortWE2 1 1 }  { bufB_im_d1 MemPortDIN2 1 32 } } }
}
